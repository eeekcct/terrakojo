...
func (in *RepositoryStatus) DeepCopyInto(out *RepositoryStatus) {
	*out = *in
	...
	if in.BranchList != nil {
		in, out := &in.BranchList, &out.BranchList
		*out = make([]BranchInfo, len(*in))
		copy(*out, *in)
	}
	if in.DefaultBranchCommits != nil {
		in, out := &in.DefaultBranchCommits, &out.DefaultBranchCommits
		*out = make([]BranchInfo, len(*in))
		copy(*out, *in)
	}
}
