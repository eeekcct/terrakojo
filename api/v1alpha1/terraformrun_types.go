...
type TerraformRunSpec struct {
	...
	Mode       string `json:"mode"` // e.g., "plan" or "apply"
...
type TerraformRunStatus struct {
	...
	// conditions represent the current state of the TerraformRun resource.
...
type TerraformRun struct {
	...
	// spec defines the desired state of TerraformRun
	// +required
	Spec TerraformRunSpec `json:"spec"`

	// status defines the observed state of TerraformRun
	// +optional
	Status TerraformRunStatus `json:"status,omitempty,omitzero"`
}
