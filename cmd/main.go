...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "99913b1e.terrakojo.io",
	...
	if err := (&controller.TerraformRepositoryReconciler{
	...
	if err := (&controller.TerraformBranchReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TerraformBranch")
		os.Exit(1)
	}
	if err := (&controller.TerraformRunReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "TerraformRun")
		os.Exit(1)
	}
